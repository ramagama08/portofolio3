<footer id="footer">
    <div class="container">
      <h3>Ramadhani Gama Maftuhin</h3>
      <p>A programmer from Assalafiyyah Vocational School</p>
  ...
  <script src="<?= base_url('assets/assets/vendor/typed.js/typed.umd.js')?>"></script>
